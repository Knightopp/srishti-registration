          ...
          <div className="p-6 rounded-3xl bg-[#0D0F16] border border-white/10 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/10">
              ...
              {teammates.length < maxTeammates && (
                <button
                  ...
                  className="btn-blue-agent-pill px-3.5 py-1.5 rounded-full text-xs font-['Outfit'] font-bold flex items-center gap-1.5"
                >
            ...
            <div className="space-y-3">
              {teammates.map((teammate, idx) => (
                <div
                  key={idx}
                  className="p-4 rounded-2xl bg-[#06070A] border border-white/10 space-y-3"
                >
                  <div className="flex items-center justify-between">
                    <span className="font-['Outfit'] text-xs font-bold text-[#38BDF8] flex items-center gap-2">
                      <span className="w-5 h-5 rounded-full bg-[#1D4ED8] flex items-center justify-center text-[10px] text-white font-bold">
                        {idx + 2}
                      </span>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                      <input
                        ...
                        placeholder="Full Name *"
                        className="w-full game-input-inset rounded-xl px-3.5 py-2 text-xs text-white placeholder:text-white/30 font-['Outfit']"
                      />
                    </div>
                    <div>
                      <input
