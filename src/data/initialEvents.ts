...
export const DEFAULT_EVENTS: EventItem[] = [
  ...
  },
  {
    ...
    eventType: 'team',
    teamSize: 'Group (3 to 12 Members)',
    minTeamSize: 3,
    maxTeamSize: 12,
  ...
  },
  {
    ...
    prize: '₹12,000 Pool',
    tags: ['Robotics', 'TraceBot', '2-4 Members', 'Hardware', 'Arduino'],
    color: '#0077ff',
    bgGradient: 'from-[#082230] via-[#091a26] to-[#080b12]',
  ...
  },
  {
    ...
    locationId: 'main-auditorium',
    prize: '₹8,000 Pool',
    tags: ['Quiz', 'Duo (Team of 2)', 'Trivia', 'Buzzer'],
    color: '#38bdf8',
  ...
  },
  {
    ...
    locationId: 'seminar-hall',
    prize: '₹6,000 Pool',
    tags: ['Face Painting', 'Duo (Team of 2)', 'Art', 'Creative'],
    color: '#0077ff',
